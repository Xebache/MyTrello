...
## Screenshots
 ...
 <div display="flex" flex-direction="row" justify-content="space-around" align-items="center" flex-wrap="wrap" align="center">
  <img alt="Screenshot" src="https://github.com/Xebache/MyTrello/blob/main/docs/login.png" height="80" />
  <img alt="Screenshot" src="https://github.com/Xebache/MyTrello/blob/main/docs/boards.png" height="80" />
  <img alt="Screenshot" src="https://github.com/Xebache/MyTrello/blob/main/docs/board.png" height="80" />
  <img alt="Screenshot" src="https://github.com/Xebache/MyTrello/blob/main/docs/collaborators.png" height="80" />
  <img alt="Screenshot" src="https://github.com/Xebache/MyTrello/blob/main/docs/card.png" height="80" />
</div>
